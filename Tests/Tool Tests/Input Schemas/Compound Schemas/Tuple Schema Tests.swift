...
struct TupleSchemaTests {
  ...
  private func testValueEncoding() throws {
    ...
    let value1 = schema1.encodedJSON(for: schema1.value(fromJSON: """
    ["foo", 42]
    """))
    ...
    let value2 = schema2.encodedJSON(for: schema2.value(fromJSON: """
    ["bar", 123, 3.14]
    """))
  ...
  private func testValueDecoding() throws {
    ...
    let tuple: (String, Int) = stringIntSchema.value(fromJSON: """
    ["hello", 42]
    """)
    ...
    let tuple3: (String, Int, Double) = stringIntDoubleSchema.value(fromJSON: """
    ["world", 123, 3.14]
    """)
