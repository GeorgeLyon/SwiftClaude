  ...
  /*
    ...
    func negativeNumberTest() async throws {
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "-42")
          #expect($0.integerPart == "-42")
          #expect($0.fractionalPart == nil)
          #expect($0.exponent == nil)
        }
    ...
    func zeroTest() async throws {
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "0")
          #expect($0.integerPart == "0")
          #expect($0.fractionalPart == nil)
          #expect($0.exponent == nil)
        }
    ...
    func decimalTest() async throws {
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "123.456")
          #expect($0.significand == "123.456")
          #expect($0.integerPart == "123")
          #expect($0.fractionalPart == "456")
          #expect($0.exponent == nil)
        }
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "3.1")
          #expect($0.significand == "3.1")
          #expect($0.integerPart == "3")
          #expect($0.fractionalPart == "1")
          #expect($0.exponent == nil)
        }
  
        decoder.stream.push("415")
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "3.1415")
          #expect($0.significand == "3.1415")
          #expect($0.integerPart == "3")
          #expect($0.fractionalPart == "1415")
          #expect($0.exponent == nil)
        }
    ...
    func negativeDecimalTest() async throws {
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "-99.99")
          #expect($0.significand == "-99.99")
          #expect($0.integerPart == "-99")
          #expect($0.fractionalPart == "99")
          #expect($0.exponent == nil)
        }
    ...
    func scientificNotationTest() async throws {
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "1.23e10")
          #expect($0.significand == "1.23")
          #expect($0.integerPart == "1")
          #expect($0.fractionalPart == "23")
          #expect($0.exponent == "10")
        }
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "2.5E+3")
          #expect($0.significand == "2.5")
          #expect($0.integerPart == "2")
          #expect($0.fractionalPart == "5")
          #expect($0.exponent == "+3")
        }
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "42e2")
          #expect($0.significand == "42")
          #expect($0.integerPart == "42")
          #expect($0.fractionalPart == nil)
          #expect($0.exponent == "2")
        }
    ...
    func whitespaceBeforeNumberTest() async throws {
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "456")
          #expect($0.integerPart == "456")
          #expect($0.fractionalPart == nil)
          #expect($0.exponent == nil)
        }
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "789")
          #expect($0.integerPart == "789")
          #expect($0.fractionalPart == nil)
          #expect($0.exponent == nil)
        }
    ...
    func incrementalParsingTest() async throws {
      ...
      do {
        var decoder = JSON.NumberDecoder()
        decoder.stream.push("1.5e")
  
        // No complete number yet
        decoder.stream.push("10")
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "1.5e10")
          #expect($0.significand == "1.5")
          #expect($0.integerPart == "1")
          #expect($0.fractionalPart == "5")
          #expect($0.exponent == "10")
        }
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "2.0E-5")
          #expect($0.significand == "2.0")
          #expect($0.integerPart == "2")
          #expect($0.fractionalPart == "0")
          #expect($0.exponent == "-5")
        }
    ...
    func edgeCasesTest() async throws {
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "0.0")
          #expect($0.significand == "0.0")
          #expect($0.integerPart == "0")
          #expect($0.fractionalPart == "0")
          #expect($0.exponent == nil)
        }
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "0e0")
          #expect($0.significand == "0")
          #expect($0.integerPart == "0")
          #expect($0.fractionalPart == nil)
          #expect($0.exponent == "0")
        }
      ...
      do {
        ...
        try decoder.withDecodedNumber {
          #expect($0.stringValue == "123456789012345678901234567890")
          #expect($0.integerPart == "123456789012345678901234567890")
          #expect($0.fractionalPart == nil)
          #expect($0.exponent == nil)
        }
