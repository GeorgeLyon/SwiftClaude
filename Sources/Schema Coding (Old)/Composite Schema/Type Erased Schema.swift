...
extension SchemaCoding.Support {
  ...
  public struct TypeErasedSchema<Value>: Schema {
    ...
    public var metaSchema: TypeErasedSchema<Self> {
      wrapped.typeErasedMetaSchema.typeErased()
    }
    ...
    fileprivate var wrapped: any Schema<Value>
