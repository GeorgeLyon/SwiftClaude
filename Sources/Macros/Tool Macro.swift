...
extension DeclGroupSyntax {
    ...
    -> MemberBlockItemListSyntax
  {
    ...
    let storedProperties: [StructDeclSyntax.StoredProperty] =
      ...
      .parameterClause
      .parameters
      .compactMap { parameter -> StructDeclSyntax.StoredProperty? in
              ...
              CodeBlockItemListSyntax {
                FunctionCallExprSyntax(
                  ...
                  arguments: LabeledExprListSyntax {
                    ...
                    if let description = parseArguments(
                      as: DescriptionArgument.self,
                      forAttributeName: "Tool",
                      in: context
                    ) {
                      description.labeledExpr(
...
extension FunctionDeclSyntax {
  ...
  fileprivate func callExpr<Argument: ExprSyntaxProtocol>(
