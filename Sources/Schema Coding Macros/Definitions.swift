...
struct StructSchema {
  ...
  struct Property {
    ...
    let storedPropertyName: TokenSyntax
  }
...
struct SchemaCodableType {
  ...
  /// The type syntax for the decorated declaration, including any generic
  /// parameters bound by name (e.g. `SchemaCoding.Support.IntegerSchema<T>`).
